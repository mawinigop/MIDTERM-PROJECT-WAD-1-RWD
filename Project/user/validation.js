...
[names, email, phone, birth, allergies, medications, pregnancys, appointmentDate, medicalservices].forEach(input => {
   if (input) {
...
const validateForm = () => {
  let valid = true;
  [names, email, phone, birth, allergies, medications, pregnancys, noneBox, medicalservices, appointmentDate, medicalservices].forEach(f => {
